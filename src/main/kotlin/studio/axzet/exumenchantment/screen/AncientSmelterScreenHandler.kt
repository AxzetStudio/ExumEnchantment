...
class AncientSmelterScreenHandler: ScreenHandler {
    ...
    constructor(syncId: Int, playerInventory: PlayerInventory, inventory: Inventory, delegate: PropertyDelegate): super(ExumEnchantmentScreenHandlers.ANCIENT_SMELTER_SCREEN_HANDLER, syncId) {
