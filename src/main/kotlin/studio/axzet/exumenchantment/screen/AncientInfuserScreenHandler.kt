...
class AncientInfuserScreenHandler: ScreenHandler {
    ...
    constructor(syncId: Int, playerInventory: PlayerInventory, inventory: Inventory, delegate: PropertyDelegate) : super(ExumEnchantmentScreenHandlers.ANCIENT_INFUSER_SCREEN_HANDLER, syncId) {
