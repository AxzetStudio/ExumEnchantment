...
class AncientEnchanterScreenHandler: ScreenHandler {
    ...
    constructor(syncId: Int, playerInventory: PlayerInventory, inventory: Inventory, delegate: PropertyDelegate) : super(ExumEnchantmentScreenHandlers.ANCIENT_ENCHANTER_SCREEN_HANDLER, syncId) {
    ...
    fun getScaledProgress(): Int {
        ...
        val progressArrowSize = 48 // Width in pixels of the arrow
