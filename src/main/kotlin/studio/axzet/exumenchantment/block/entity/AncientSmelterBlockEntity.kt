...
import studio.axzet.exumenchantment.screen.AncientSmelterScreenHandler
...
class AncientSmelterBlockEntity: BlockEntity, NamedScreenHandlerFactory, ImplementedInventory {
    ...
    constructor(pos: BlockPos, state: BlockState) : super(ExumEnchantmentBlockEntities.ANCIENT_SMELTER, pos, state) {
    ...
    companion object {
        ...
        private fun craftItem(entity: AncientSmelterBlockEntity) {
            ...
            if (hasRecipe(entity)) {
                ...
                entity.setStack(2, ItemStack(ExumEnchantmentItems.INCANTATIO, entity.getStack(2).count + 1))
        ...
        private fun hasRecipe(entity: AncientSmelterBlockEntity): Boolean {
            ...
            var hasRawIncantatioInFirstSlot: Boolean = entity.getStack(1).item == ExumEnchantmentItems.RAW_INCANTATIO
            var hasInfusedCopperInFuelSlot: Boolean = entity.getStack(0).item == ExumEnchantmentItems.INFUSED_COPPER

            return hasRawIncantatioInFirstSlot
                    && hasInfusedCopperInFuelSlot
                    && canInsertAmountInOutputSlot(inventory)
                    && canInsertItemIntoOutputSlot(inventory, ExumEnchantmentItems.INCANTATIO)
        }
