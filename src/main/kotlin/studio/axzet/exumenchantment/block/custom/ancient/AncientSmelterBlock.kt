...
import studio.axzet.exumenchantment.block.entity.AncientSmelterBlockEntity
...
class AncientSmelterBlock: BlockWithEntity, BlockEntityProvider {
    ...
    override fun <T : BlockEntity> getTicker(
        ...
        return checkType(type, ExumEnchantmentBlockEntities.ANCIENT_SMELTER, AncientSmelterBlockEntity::tick)
    }
}